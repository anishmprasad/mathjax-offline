	...
	if (!(window.MathJax && MathJax.Hub)) {
		...
		(function (d) {
			...
			var g = MathJax.Object.Subclass(
				...
				{ id: 'Jax', version: '2.7.3', directory: e + '/jax', extensionDir: e + '/extensions' }
			);
			b.InputJax = g.Subclass(
				...
				{ id: 'InputJax', version: '2.7.3', directory: g.directory + '/input', extensionDir: g.extensionDir }
			);
		...
		(function (o) {
			...
			try {
				d.Browser.Select({
					...
					Opera: function (i) {
						i.version = window.opera.version();
					},
					Edge: function (i) {
					...
					MSIE: function (j) {
						...
						if (document.documentMode < 10 && !s.params.NoMathPlayer) {
							try {
								new window.ActiveXObject('MathPlayer.Factory.1');
